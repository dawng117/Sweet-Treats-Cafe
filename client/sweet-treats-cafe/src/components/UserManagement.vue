<template>
  <div class="bg-white shadow overflow-hidden sm:rounded-lg">
    <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
      <div>
        <h3 class="text-lg leading-6 font-medium text-gray-900">Danh sách tất cả người dùng trong hệ thống</h3>
      </div>
      <div v-if="loading" class="animate-spin h-5 w-5 text-pastel-pink">
    ...
    <div v-if="error" class="bg-red-100 border-l-4 border-red-400 text-red-700 p-4">
      <p>{{ error }}</p>
    </div>
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <div v-if="user.phone" class="text-xs text-gray-500">
                    {{ user.phone }}
                  </div>
                </div>
              </div>
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Xác nhận xóa người dùng</h3>
        ...
        <div class="flex justify-end space-x-3">
          ...
          <button 
            ...
            :disabled="isDeleting"
            class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors disabled:bg-red-300"
          >
    ...
    <div v-if="showRoleModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Xác nhận thay đổi vai trò</h3>
        <p class="text-sm text-gray-500 mb-4">
        ...
        <div class="flex justify-end space-x-3">
          ...
          <button 
            ...
            :disabled="isUpdating"
            class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors disabled:bg-indigo-300"
          >
    ...
    <div v-if="showLockModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-6 max-w-md mx-auto">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Xác nhận {{ userToToggleLock?.isLocked ? 'mở khóa' : 'khóa' }} tài khoản</h3>
        <p class="text-sm text-gray-500 mb-4">
